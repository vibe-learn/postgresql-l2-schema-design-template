"""Tests for the `l2_schemas_tables_types` homework scaffold.
...
def test_integration():
    """Интеграция: подключиться к реальному PostgreSQL и проверить логику урока «Схемы, таблицы, типы и constraint-ы»."""
